...
const AdminRegistration = ()=>{
    ...
    const submitForm = async(event)=>{
      ...
      try{
        const options = {
          ...
          const response = await fetch("https://ecommercebackend-2-tnje.onrender.com/Admin/AdminRegister",options);
    ...
    return(
        ...
        <Link className="linkstyle" to="/AdminLogin"><h1>Already registered ? Click here to login!</h1></Link>
        </div>
